...
namespace Exercise4_DesignADatabaseConnection
{
     ...
     * We don’t know how to open or close a connection in a DbConnection
     * and this should be left to the classes that derive from DbConnection.
     ...
     * of opening and closing connections using Console.WriteLine().
    ...
    class Program
    {
        ...
        {
            // Create an Oracle database connection with a null connection string
            var OracleTestConnection = new OracleConnection(null);

            // Create an SQL database connection with a whitespace connection string
            var SqlTestConnection = new SqlConnection(" ");
            ...
            // Try opening an already open connection
            SqlConnection.OpenConnection();
